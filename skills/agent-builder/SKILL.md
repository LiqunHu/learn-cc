...
- `references/minimal-agent.mjs` - Complete working agent (~100 lines)
- `references/tool-templates.mjs` - Capability definitions
- `references/subagent-pattern.mjs` - Context isolation

**Scaffolding**:
- `scripts/init_agent.mjs` - Generate new agent projects (`node init_agent.mjs <name>`)
